...
public class NotenSchema {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Wie viel Prozent wurden erreicht?");
        ...
        if (Prozent >= 27 && Prozent <= 44 || Prozent == 27) {
            System.out.println("Die Note 5 wurde erreicht");

        }else

        if (Prozent >= 45 && Prozent <= 59 || Prozent == 45) {
            System.out.println("Die Note 4 wurde erreicht");

        }else

        if (Prozent >= 59 && Prozent <= 72 || Prozent == 59) {
            System.out.println("Die Note 3 wurde erreicht");

        }else

        if (Prozent >= 73 && Prozent <= 84 || Prozent == 73) {
